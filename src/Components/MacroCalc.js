    ...
    render() {
        return (
            <div className='macro_calc'>
                <h2> BMR & MacroCalc</h2>
                <p> To calculate your daily calorie and macro goals, simply fill out the information on the calculator below! </p>
                <div className='inputs_container'>
                            ...
                            <h4>Enter Age</h4>
                            <input  class='input' type='text' name='' placeholder='Age'></input>
                            <h4>Enter Weight</h4>
